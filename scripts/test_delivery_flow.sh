...
echo -e "${BLUE}1️⃣ Creando envío...${NC}"
...
echo -e "${BLUE}2️⃣ Listando envíos del usuario...${NC}"
...
echo -e "${BLUE}3️⃣ Obteniendo todos los envíos (GET /deliveries)...${NC}"
...
echo -e "${BLUE}4️⃣ Creando envío para otro usuario...${NC}"
...
echo -e "${BLUE}5️⃣ Validando filtrado por usuario...${NC}"
...
echo -e "${BLUE}6️⃣ Verificando estructura de datos...${NC}"
